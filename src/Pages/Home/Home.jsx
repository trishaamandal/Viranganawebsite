      ...
      <footer>
        <div className="footer-container">
          <p className="footer-head">
            &#169; 2025 VIRANAGA. All Rights Reserved.
          </p>
          ...
          {/* <div className="footer-image">
            <img src="/Assets/FOOT.png" alt="Footer logo" />
          </div> */}
          <p className="footer-creator">
            Developed by{" "}
            <a
              href="https://trishamandal2004.netlify.app/"
              target="_blank"
              rel="noreferrer"
            >
              TRISHA MANDAL
          ...
          <div className="footer-url" rel="noopener">
            ...
            <a
              href="https://www.linkedin.com/in/trishamandal123/"
              target="_blank"
              rel="noreferrer"
            >
              <BsLinkedin />
